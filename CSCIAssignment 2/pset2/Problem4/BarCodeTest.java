...
* CSCI E-10b, Homework 5, part 2 (2018)
*
...
public class BarCodeTest
{
	public static void main( String [] args )
	{
		...
		[2] valid bar code - 78240 (9)
		[3] bad bar code - bad check digit (0)
		[4] bad bar code - length 31
		[5] bad bar code - missing final frame bar
		[6] bad zip code (contains letter)
		If there are other codes you would like to test,
		include them in the array below.
		...
		*/
		...
		for ( int i = 0; i < tester.length; i++ ) 
		{
			...
			try {
				...
				System.out.println ( "\tBar code is : " + bc.getBarCode() +
				"; zip is : " + bc.getZipCode() );
				}
