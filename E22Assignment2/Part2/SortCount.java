...
public class SortCount {
    ...
    /** bubbleSort2  is a more efficient version of bubbleSort.  This version sorts in linear efficiency O(n) for fully sorted
     * arrays, and n log n efficiency for almost sorted arrays because it breaks the iteration once all values have been sorted.
     * It also ends the inner loop where a swap has been made, which eliminates some comparisons as well.   
     * Compared to the original bubbleSort, this method is still quadratic when sorting random arrays, but it makes slightly less 
     * comparisons on the randomly assorted arrays.  The number of moves are the same for both methods.
     */
    public static void bubbleSort2(int[] arr) 
    {
        int indexOfSwap = arr.length-1;
        int indexPlaceHolder = arr.length-1;
        ...
        for(int i=0; i<arr.length-1; i++)
        {
            ...
            if(endSort) return;
            indexOfSwap = indexPlaceHolder;
        }      

    }


    /** bubbleSort3 is my first attempt at a more efficient version of bubbleSort.  This version will sort an almost sorted
     * and a sorted array more efficiently than the original, but for a random array it is less efficient in total number of comparisons.
     * However, it is still technically as efficient at sorting random arrays according to big O notation where it is quadratic.  
     */
    ...
    public static void main(String args[]) {
        ...
        // Create a constant variable for the number of trials
        final int TRIALS = 10;

        // variables used to store the aggregated total number of moves and comparisons for each trial
        long moveSum1 = 0;
        long compSum1 = 0;
        long moveSum2 = 0;
        long compSum2 = 0;
        ...
        // Iterate each method for the number of trials and keep an aggregated total of the moves and comparisons
        for(int i=0; i<TRIALS; i++)
        {
            ...
            bubbleSort3(a);
            moveSum3 += getMoves();
            compSum3 += getComparisons();
            printStats();
            printArray(a);

        }

        // Print the average moves and average comparisons 
        System.out.println();
        System.out.println("BubbleSort  -> Avg Comparisons:    " + compSum1/TRIALS + "        Avg Moves: " + moveSum1/TRIALS);
        System.out.println("BubbleSort2 -> Avg Comparisons:    " + compSum2/TRIALS + "        Avg Moves: " + moveSum2/TRIALS);
        System.out.println("BubbleSort3 -> Avg Comparisons:    " + compSum3/TRIALS + "        Avg Moves: " + moveSum3/TRIALS);
